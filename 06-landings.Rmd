...
**Figure 6-1.** Figure of oyster landings (lbs), total trips, and cost per unit effort (CPUE) for Apalachicola (blue line), Suwannee Sound (orange), and the State of Florida (pink) for years 1986 to 2021.  
...
**Figure 6-2.** Figure of oyster landings (lbs), total trips, and cost per unit effort (CPUE) for Apalachicola (blue line), Suwannee Sound (orange) for years 2012 to 2021.  
...
**Figure 6-3.** Figure of oyster landings (lbs), total trips, and cost per unit effort (CPUE) for Apalachicola (blue line), Suwannee Sound (orange) for years 2015 to 2021.  
