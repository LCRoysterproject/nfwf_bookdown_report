...
```{r, include= FALSE}
wind0 <- wind %>%
  filter(time >= "2021-07-01 00:00:00" & time <= "2021-07-31 00:00:00") %>%
  select(time, wind_spd, wind_dir)

wind1 <- wind %>%
  filter(time >= "2021-08-01 00:00:00" & time <= "2021-08-31 00:00:00") %>%
  select(time, wind_spd, wind_dir)


wind2 <- wind %>%
  filter(time >= "2021-09-01 00:00:00" & time <= "2021-09-30 00:00:00") %>%
  select(time, wind_spd, wind_dir)


july_plot<-plot.windrose(spd = wind0$wind_spd,
                         dir = wind0$wind_dir)

aug_plot<-plot.windrose(spd = wind1$wind_spd,
                    dir = wind1$wind_dir)

sept_plot<-plot.windrose(spd = wind2$wind_spd,
                          dir = wind2$wind_dir)
```
