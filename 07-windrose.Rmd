...
wind <- rbind(wind21$data, wind22$data) %>% dplyr::distinct()
...
```{r, include= FALSE}
wind0 <- wind %>%
  filter(time >= "2022-01-01 00:00:00" & time <= "2022-01-31 00:00:00") %>%
  select(time, wind_spd, wind_dir)

wind1 <- wind %>%
  filter(time >= "2022-02-01 00:00:00" & time <= "2022-02-28 00:00:00") %>%
  select(time, wind_spd, wind_dir)
