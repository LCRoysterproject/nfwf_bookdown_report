...
```{r, include= FALSE}
wind0 <- wind %>%
  filter(time >= "2023-05-01 00:00:00" & time <= "2023-05-31 00:00:00") %>%
  select(time, wind_spd, wind_dir)

wind1 <- wind %>%
  filter(time >= "2023-06-01 00:00:00" & time <= "2023-06-30 00:00:00") %>%
  select(time, wind_spd, wind_dir)
